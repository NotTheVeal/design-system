...
const meta:Meta<typeof Checkbox>={title:'Components/Checkbox',component:Checkbox,tags:['autodocs'],
  parameters:{docs:{description:{component:'`current`=Orange#FF9505 ADA-FAIL(2.9:1) legacy-only | `future`=Blue#005BA6 ADA-PASS(4.8:1) approved'}}},
...
const Banner=({s}:{s:'current'|'future'})=>s==='future'
  ...
  :<div style={{padding:'8px 12px',background:'#FACBCB',borderRadius:4,fontSize:12,color:'#C00',fontFamily:'sans-serif',marginBottom:8}}>⚠️ LEGACY — Orange #FF9505 — 2.9:1 — ADA NON-COMPLIANT — DO NOT USE IN PRODUCTION</div>;
...
export const SideBySide:Story={name:'🔄 Side-by-Side: Current vs Future',render:()=>(
  <div style={{display:'flex',gap:40,fontFamily:"'Source Sans Pro',sans-serif"}}>
    <div><div style={{fontSize:11,fontWeight:700,color:'#C00',marginBottom:8}}>⚠️ CURRENT — Orange #FF9505</div><Toggle colorScheme="current" label="Off"/><div style={{marginTop:12}}/><Toggle colorScheme="current" checked label="On"/></div>
    <div style={{width:1,background:'#DCDCDC'}}/>
...
const meta:Meta<typeof ProductCard>={title:'Components/ProductCard',component:ProductCard,tags:['autodocs'],parameters:{docs:{description:{component:'`current`=Orange#FF9505 CTAs ADA-FAIL | `future`=Blue#005BA6 CTAs ADA-PASS'}}}};
...
export const SideBySide:Story={name:'🔄 Side-by-Side: Current vs Future',render:()=>(
  <div style={{display:'flex',gap:32,padding:24,flexWrap:'wrap',fontFamily:"'Source Sans Pro',sans-serif"}}>
    <div><div style={{fontSize:11,fontWeight:700,color:'#C00',marginBottom:8}}>⚠️ CURRENT — Orange #FF9505</div><ProductCard colorScheme="current"/></div>
