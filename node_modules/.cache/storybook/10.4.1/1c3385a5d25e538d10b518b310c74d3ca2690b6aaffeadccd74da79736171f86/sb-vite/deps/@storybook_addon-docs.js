import { pt as __export, vt as definePreviewAddon10 } from "./blocks-Bz_5HreR.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-PvnMPbz_.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-BqWJ3_6L.js");
