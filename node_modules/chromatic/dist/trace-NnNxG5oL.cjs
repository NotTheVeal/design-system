...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="1882c5b9-9f04-5e7d-a2eb-4634c97f4163")}catch(e){}}();
const e=require(`./chunk-gGpyby2o.cjs`),t=require(`./meow-Cmqsflq2.cjs`),n=require(`./turbosnap-DntOl2F0.cjs`),r=require(`./log-BI_UMjxm.cjs`),i=require(`./readStatsFile-BZQOIcua.cjs`);var a=e.a(t.t());const{STORYBOOK_BASE_DIR:o,STORYBOOK_CONFIG_DIR:s,WEBPACK_STATS_FILE:c}=process.env;async function l(e){let{flags:t,input:l}=(0,a.default)(`
    Usage
    ...
    `,{argv:e,description:`Trace utility for TurboSnap`,flags:{statsFile:{type:`string`,alias:`s`,default:c||`storybook-static/preview-stats.json`},storybookBaseDir:{type:`string`,alias:`b`,default:o||`.`},storybookConfigDir:{type:`string`,alias:`c`,default:s||`.storybook`},untraced:{type:`string`,alias:`u`,isMultiple:!0},mode:{type:`string`,alias:`m`}}}),u=r.t({},{logPrefix:``,logLevel:`info`}),d={log:u,options:{storybookBaseDir:t.storybookBaseDir,storybookConfigDir:t.storybookConfigDir,untraced:t.untraced,traceChanged:t.mode||!0},git:{rootPath:await n.z({log:u})},storybook:{baseDir:t.storybookBaseDir,configDir:t.storybookConfigDir}},f=await i.t(t.statsFile),p=l.map(e=>e.replace(/^\.\//,``)),m=p.find(e=>n.s(e));if(m)throw Error(`Unable to trace package manifest file (${m}) as that would require diffing file contents.`);await n.n(d,f,t.statsFile,p)}exports.main=l;
//# sourceMappingURL=trace-NnNxG5oL.cjs.map
//# debugId=1882c5b9-9f04-5e7d-a2eb-4634c97f4163
