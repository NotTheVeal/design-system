    ...
    render: () => (
          <div style={{ display: 'flex', gap: 0, fontFamily: "'Source Sans 3', sans-serif", borderRadius: 8, overflow: 'hidden', border: '1px solid #DCDCDC', maxWidth: 720 }}>
                  <div style={{ flex: 1, padding: 24, background: '#FFFFFF' }}>
                            <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', color: '#777777', marginTop: 0, marginBottom: 16 }}>CURRENT — colorScheme="current" (Orange)</p>p>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                                        <Button variant="primary" size="lg" colorScheme="current">Primary (default)</Button>Button>
                                      <Button variant="secondary" size="lg" colorScheme="current">Secondary</Button>Button>
                            </div>div>
                  </div>div>
                <div style={{ width: 1, background: '#DCDCDC', flexShrink: 0 }} />
                <div style={{ flex: 1, padding: 24, background: '#FFFFFF' }}>
                        <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', color: '#005BA6', marginTop: 0, marginBottom: 16 }}>FUTURE — colorScheme="future" (PS Blue)</p>p>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                                  <Button variant="primary" size="lg" colorScheme="future">Primary (default)</Button>Button>
                                  <Button variant="secondary" size="lg" colorScheme="future">Secondary</Button>Button>
                        </div>div>
                </div>div>
          </div>div>
        ),
    ...
    render: () => (
          <div style={{ fontFamily: "'Source Sans 3', sans-serif" }}>
                <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                        <Button variant="primary" size="lg" colorScheme="current">Primary</Button>Button>
                        <Button variant="secondary" size="lg" colorScheme="current">Secondary</Button>Button>
                </div>div>
          </div>div>
        ),
...
export const AllVariants: Story = {
    ...
    render: () => (
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', alignItems: 'center', fontFamily: "'Source Sans 3', sans-serif", padding: 16 }}>
                <Button variant="primary" size="lg" colorScheme="future">Primary</Button>Button>
                <Button variant="secondary" size="lg" colorScheme="future">Secondary</Button>Button>
                <Button variant="tertiary" colorScheme="future">Tertiary</Button>Button>
                <Button variant="ghost" size="lg" colorScheme="future">Ghost</Button>Button>
                <Button variant="danger" size="lg" colorScheme="future">Danger</Button>Button>
          </div>div>
        ),
};
...
export const SizeComparison: Story = {
    ...
    render: () => (
          <div style={{ display: 'flex', gap: 24, alignItems: 'center', fontFamily: "'Source Sans 3', sans-serif", padding: 16 }}>
                <Button variant="primary" size="lg" colorScheme="future">Large (50px)</Button>Button>
                <Button variant="primary" size="sm" colorScheme="future">Small (32px)</Button>Button>
          </div>div>
        ),
};
</Button>tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component: `
