...
const slide = (title: string, subtitle: string, bg: string) => ({
  content: (
    <div style={{
      height: 200, background: bg, borderRadius: 8,
...
export const NoArrows: Story = {
  render: () => (
    <div style={{ width: 560 }}>
      <Carousel showArrows={false} items={[
...
export const SingleItem: Story = {
  render: () => (
    <div style={{ width: 560 }}>
      <Carousel items={[slide('MRI Suite Upgrade Complete', 'Siemens MAGNETOM Aera installed and operational', '#17AB78')]} />
    </div>
  ),
};
      ...
      <Carousel items={[
        {
          content: (
            <div style={{ border: '1px solid #DCDCDC', borderRadius: 8, padding: 24, background: '#fff', fontFamily: "'Source Sans Pro', sans-serif" }}>
              <div style={{ fontSize: 13, color: '#777777', marginBottom: 4 }}>Part #MRI-7842</div>
        ...
        },
        {
          content: (
            <div style={{ border: '1px solid #DCDCDC', borderRadius: 8, padding: 24, background: '#fff', fontFamily: "'Source Sans Pro', sans-serif" }}>
              <div style={{ fontSize: 13, color: '#777777', marginBottom: 4 }}>Part #CT-4421</div>
