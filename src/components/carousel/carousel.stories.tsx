...
export const Default: Story = {
  render: () => (
    <div style={{ width: 560 }}>
      <Carousel
        items={[
          slide('Siemens MAGNETOM Aera', 'MRI System Â· 1.5T Â· 70cm bore', '#005BA6'),
          slide('GE Revolution CT', 'CT Scanner Â· 256-slice Â· Wide bore', '#002F48'),
          slide('Philips EPIQ Elite', 'Ultrasound System Â· Cardiology', '#009CF4'),
          slide('Canon Aquilion ONE', 'CT System Â· 320-row detector', '#17AB78'),
        ]}
      />
    </div>
  ),
