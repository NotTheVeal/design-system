...
export const Default: Story = {
  args: {
    variant: 'default',
    title: 'New parts catalog available â updated pricing effective July 1, 2026',
...
export const Info: Story = {
  args: {
    variant: 'info',
    title: 'Scheduled maintenance window: Jun 15, 2026 from 2:00â4:00 AM EST',
...
export const Success: Story = {
  args: {
    variant: 'success',
    title: 'Order #PRO-20941 confirmed â estimated delivery Jun 13, 2026',
    onClose: () => {},
  },
};
