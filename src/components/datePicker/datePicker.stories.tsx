...
export const Current_WithValue:Story={name:'⚠️ Current · With Selected Date (Legacy)',args:{colorScheme: 'future',value:new Date(2026,5,15),label:'Service Date'}};
export const SideBySide:Story={name:'🔄 Side-by-Side: Current vs Future',render:()=>(
  <div style={{display:'flex',gap:48,padding:24,fontFamily:"'Source Sans Pro',sans-serif"}}>
    <div><div style={{fontSize:11,fontWeight:700,color:'#C00',marginBottom:8}}>⚠️ CURRENT — Orange #005BA6</div><DatePicker colorScheme="future" label="Event Date" value={new Date(2026,5,15)}/></div>
