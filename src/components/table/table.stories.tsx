...
const data = [
{ id: '1', supplier: 'GE Healthcare', category: 'Imaging', orders: '24', spend: '$184,200', status: <span style={{ color: statusColor('Active'), fontWeight: 600, fontSize: 13 }}>â Active</span> },
{ id: '2', supplier: 'Philips Healthcare', category: 'Monitoring', orders: '18', spend: '$142,800', status: <span style={{ color: statusColor('Active'), fontWeight: 600, fontSize: 13 }}>â Active</span> },
{ id: '3', supplier: 'Siemens Healthineers', category: 'CT / MRI', orders: '11', spend: '$310,500', status: <span style={{ color: statusColor('Expiring Soon'), fontWeight: 600, fontSize: 13 }}>â Expiring Soon</span> },
{ id: '4', supplier: 'Mindray', category: 'Patient Care', orders: '7', spend: '$38,900', status: <span style={{ color: statusColor('Inactive'), fontWeight: 600, fontSize: 13 }}>â Inactive</span> },
];
...
// ââ NEW: WithToggle story ââââââââââââââââââââââââââââââââââââââââââââââââââââââ
