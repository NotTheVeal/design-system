 ...
 * bg: #002F48 (Midnight), height: 56px, active: border-bottom 3px solid #009CF4
 */
...
export const NavTop = forwardRef<HTMLElement, NavTopProps>(function NavTop({ logo, links = [], search, actions, className, style, ...rest }, ref) {
  ...
  return (
    <header ref={ref} role="banner" className={['ps-navtop', className].filter(Boolean).join(' ')} style={{ position: 'relative', display: 'flex', alignItems: 'center', borderBottom: '1px solid #DCDCDC', height: '64px', backgroundColor: '#FFFFFF', padding: '0 24px', boxSizing: 'border-box', width: '100%', fontFamily: FONT, flexShrink: 0, ...style }} {...rest}>
