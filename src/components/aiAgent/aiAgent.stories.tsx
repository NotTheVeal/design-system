...
export const Loading: Story = {
  args: { messages: SAMPLE_MESSAGES.slice(0, 3), isLoading: true },
  render: (args) => <div style={{ maxWidth: 600 }}><AiAgent {...args} /></div>,
};
export const Interactive: Story = {
  render: () => {
    ...
    const responses = [
      'Hello! I can help you find parts, check inventory, compare vendors, or answer procurement questions. What do you need today?',
      'I found 12 results for that query. The top match is GE Healthcare SKU 4542-0012 at $1,249.00, currently In Stock with 2-day delivery.',
      'Your order history shows 47 orders this quarter, totaling $128,450. Your most ordered category is Imaging & Diagnostics (38% of spend).',
    ];
    let callCount = 0;
