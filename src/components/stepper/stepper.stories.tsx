...
export const Current_Step2:Story={name:'⚠️ Current · Step 2 Active (Legacy Orange)',render:()=><div style={{padding:24}}><B s="current"/><Stepper colorScheme="future" steps={STEPS} currentStep={1}/></div>};
export const SideBySide:Story={name:'🔄 Side-by-Side: Current vs Future',render:()=>(
  <div style={{display:'flex',flexDirection:'column',gap:32,padding:24,fontFamily:"'Source Sans Pro',sans-serif"}}>
    <div><div style={{fontSize:11,fontWeight:700,color:'#C00',marginBottom:8}}>⚠️ CURRENT — Orange #005BA6 · 2.9:1 · FAILS WCAG AA</div><Stepper colorScheme="future" steps={STEPS} currentStep={1}/></div>
